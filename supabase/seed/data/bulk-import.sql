...
((SELECT id FROM restaurants WHERE name = 'Coop de Ville'), 'Local Hand-dug Steamers', 'clams', 32.00),
...
((SELECT id FROM restaurants WHERE name = 'Coop de Ville'), 'Clam Strip Basket', 'clams', 19.00),
((SELECT id FROM restaurants WHERE name = 'Coop de Ville'), 'Beer Battered Shrimp Basket', 'fish', 18.00),
((SELECT id FROM restaurants WHERE name = 'Coop de Ville'), 'Whole Belly Clam Basket', 'clams', 29.00),
...
((SELECT id FROM restaurants WHERE name = 'Lookout Tavern'), 'Steamed Clams', 'clams', 22.00),
...
((SELECT id FROM restaurants WHERE name = 'Rockfish'), 'Whole Belly Clam Plate', 'clams', 35.00),
